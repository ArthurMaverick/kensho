...
func printInfo(r *dns.Msg) []string {
	var dnsList []string

	for _, a := range r.Answer {
		formatedDns := fmt.Sprintf("%v\n", a)
		dnsList = append(dnsList, formatedDns)
	}
	return dnsList
}

func query(s string, ui uint16, c *dns.Client, config dns.ClientConfig) []string {
	//print(s)
